...
void inserirValoresVertices(){
    ...
    for (int i = 0; i <= 80; i++){
        ...
        int pinoVermelho = verificar_vermelho(vermelho_pino_2, vermelho_pino_3, i);
    
        if (i >= 26 && pinoVermelho == 3){
            vermelho = 3;
            verificar_pinos(amarelo_pino_2, amarelo_pino_3, verde_pino_2, verde_pino_3, rosa_pino_2, rosa_pino_3, i, vermelho);
        }

        else if (i >= 26 && pinoVermelho == 2){ // vermelho = 2
            vermelho = 2;
            verificar_pinos(amarelo_pino_2, amarelo_pino_3, verde_pino_2, verde_pino_3, rosa_pino_2, rosa_pino_3, i, vermelho);
        }
